...
// FontDemo.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CFontDemoApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CFontDemoApp::OnAppAbout)
...
// Создание CFontDemoApp

CFontDemoApp::CFontDemoApp() noexcept
{

	// TODO: замените ниже строку идентификатора приложения строкой уникального идентификатора; рекомендуемый
	// формат для строки: ИмяКомпании.ИмяПродукта.СубПродукт.СведенияОВерсии
	SetAppID(_T("FontDemo.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CFontDemoApp

CFontDemoApp theApp;


// Инициализация CFontDemoApp
...
// Обработчики сообщений CFontDemoApp
